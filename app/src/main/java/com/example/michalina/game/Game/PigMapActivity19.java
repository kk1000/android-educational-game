...
public class PigMapActivity19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        startService(new Intent(PigMapActivity19.this, SoundService.class));
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_map_pig19);
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f1) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.pig19a));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f2) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.pig19b));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f3) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.pig19c));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f4) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.pig19d));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f5) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.pig19e));
                        d5.setColorFilter(Color.parseColor("#d2b48c"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f6) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.pig19f));
                        d6.setColorFilter(Color.parseColor("#d2b48c"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f7) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.pig19g));
                        d7.setColorFilter(Color.parseColor("#d2b48c"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f8) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.pig19h));
                        d8.setColorFilter(Color.parseColor("#d2b48c"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f9) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.pig19i));
                        d9.setColorFilter(Color.parseColor("#d2b48c"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
    ...
    public void turnOffMusic(View v){
        ...
        imageButton4.setVisibility(View.INVISIBLE);
        imageButton5.setVisibility(View.VISIBLE);
        stopService(new Intent(PigMapActivity19.this, SoundService.class));
    }
    ...
    public void repeatGame(View v){
        stopService(new Intent(PigMapActivity19.this, SoundService.class));
        Intent gamePage = new Intent(this, PigMapActivity49.class);
