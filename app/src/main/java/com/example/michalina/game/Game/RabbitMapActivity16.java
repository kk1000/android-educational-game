...
public class RabbitMapActivity16 extends AppCompatActivity {
    ...
    Drawable drawable;
    int smileNum = 0;
    ImageView cloud, result, star;
    Button home, repeat;
    TextView plus,point1,point2,point3,point4,point5;
    RatingBar points;
    ImageView d1,d2,d3,d4,d5,d6,f1,f2,f3,f4,f5,f6, smile, sad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        startService(new Intent(RabbitMapActivity16.this, SoundService.class));
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_map_rabbit16);
        ...
        result = (ImageView) findViewById(R.id.imageView31);
        ...
        d1=(ImageView) findViewById(R.id.imageView66);
        d2=(ImageView) findViewById(R.id.imageView67);
        d3=(ImageView) findViewById(R.id.imageView68);
        d4=(ImageView) findViewById(R.id.imageView69);
        d5=(ImageView) findViewById(R.id.imageView70);
        d6=(ImageView) findViewById(R.id.imageView71);
        ...
        f1=(ImageView) findViewById(R.id.imageView72);
        f1.setOnTouchListener(new ChoiceTouchListener());
        f2=(ImageView) findViewById(R.id.imageView73);
        f2.setOnTouchListener(new ChoiceTouchListener());
        f3=(ImageView) findViewById(R.id.imageView74);
        f3.setOnTouchListener(new ChoiceTouchListener());
        f4=(ImageView) findViewById(R.id.imageView75);
        f4.setOnTouchListener(new ChoiceTouchListener());
        f5=(ImageView) findViewById(R.id.imageView76);
        f5.setOnTouchListener(new ChoiceTouchListener());
        f6=(ImageView) findViewById(R.id.imageView77);
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f1) {
                        ...
                        new CountDownTimer(1000, 100) {
                            ...
                            public void onFinish() {
                                ...
                                if(smileNum==6){
                                    ...
                                    databasePoints.setPoints_amount((int)(pointsAmount*10)+2);
                                    dbh.updatePoint(databasePoints);
                                    pointsAmount=pointsAmount+0.2;
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik16a));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f2) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik16b));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f3) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik16c));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f4) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik16d));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f5) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik16e));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f6) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik16f));
    ...
    public void turnOffMusic(View v){
        ...
        imageButton4.setVisibility(View.INVISIBLE);
        imageButton5.setVisibility(View.VISIBLE);
        stopService(new Intent(RabbitMapActivity16.this, SoundService.class));
    }
    ...
    public void repeatGame(View v){
        stopService(new Intent(RabbitMapActivity16.this, SoundService.class));
        Intent gamePage = new Intent(this, RabbitMapActivity56.class);
