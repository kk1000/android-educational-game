...
public class FishMapActivity26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        startService(new Intent(FishMapActivity26.this, SoundService.class));
        super.onCreate(savedInstanceState);

                setContentView(R.layout.activity_map_fish26);
        ...
        d6=(ImageView) findViewById(R.id.imageView18);
        d3=(ImageView) findViewById(R.id.imageView19);
        d5=(ImageView) findViewById(R.id.imageView20);
        d2=(ImageView) findViewById(R.id.imageView21);
        d4=(ImageView) findViewById(R.id.imageView22);
        ...
        f1=(ImageView) findViewById(R.id.imageView10);
        f1.setOnTouchListener(new ChoiceTouchListener());
        f2=(ImageView) findViewById(R.id.imageView24);
        f2.setOnTouchListener(new ChoiceTouchListener());
        f3=(ImageView) findViewById(R.id.imageView26);
        f3.setOnTouchListener(new ChoiceTouchListener());
        f4=(ImageView) findViewById(R.id.imageView23);
        f4.setOnTouchListener(new ChoiceTouchListener());
        f5=(ImageView) findViewById(R.id.imageView25);
        f5.setOnTouchListener(new ChoiceTouchListener());
        f6=(ImageView) findViewById(R.id.imageView27);
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f1) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba26f));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f2) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba26d));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f3) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba26b));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f4) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba26e));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f5) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba26c));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f6) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba26a));
    ...
    public void turnOffMusic(View v){
        ...
        imageButton4.setVisibility(View.INVISIBLE);
        imageButton5.setVisibility(View.VISIBLE);
        stopService(new Intent(FishMapActivity26.this, SoundService.class));
    }
    ...
    public void repeatGame(View v){
        stopService(new Intent(FishMapActivity26.this, SoundService.class));
        Intent gamePage = new Intent(this, FishMapActivity36.class);
