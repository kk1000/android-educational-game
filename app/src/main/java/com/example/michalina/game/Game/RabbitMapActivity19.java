...
public class RabbitMapActivity19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        startService(new Intent(RabbitMapActivity19.this, SoundService.class));
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_map_rabbit19);
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f1) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik19a));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f2) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik19b));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f3) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik19c));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f4) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik19d));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f5) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik19e));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f6) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik19f));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f7) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik19g));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f8) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik19h));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f9) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik19i));
    ...
    public void turnOffMusic(View v){
        ...
        imageButton4.setVisibility(View.INVISIBLE);
        imageButton5.setVisibility(View.VISIBLE);
        stopService(new Intent(RabbitMapActivity19.this, SoundService.class));
    }
    ...
    public void repeatGame(View v){
        stopService(new Intent(RabbitMapActivity19.this, SoundService.class));
        Intent gamePage = new Intent(this, RabbitMapActivity59.class);
