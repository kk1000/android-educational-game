...
public class RabbitMapActivity54 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        startService(new Intent(RabbitMapActivity54.this, SoundService.class));
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_map_rabbit44);
        ...
        d1=(ImageView) findViewById(R.id.imageView33);
        d3=(ImageView) findViewById(R.id.imageView36);
        d2=(ImageView) findViewById(R.id.imageView35);
        d4=(ImageView) findViewById(R.id.imageView37);
        d1.setColorFilter(Color.GRAY);
        d2.setColorFilter(Color.GRAY);
        d3.setColorFilter(Color.GRAY);
        d4.setColorFilter(Color.GRAY);
        f1=(ImageView) findViewById(R.id.imageView38);
        f1.setOnTouchListener(new ChoiceTouchListener());
        f2=(ImageView) findViewById(R.id.imageView39);
        f2.setOnTouchListener(new ChoiceTouchListener());
        f3=(ImageView) findViewById(R.id.imageView40);
        f3.setOnTouchListener(new ChoiceTouchListener());
        f4=(ImageView) findViewById(R.id.imageView41);
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f1) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik54a));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f2) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik54b));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f3) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik54c));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f4) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik54d));
    ...
    public void turnOffMusic(View v){
        ...
        imageButton4.setVisibility(View.INVISIBLE);
        imageButton5.setVisibility(View.VISIBLE);
        stopService(new Intent(RabbitMapActivity54.this, SoundService.class));
    }
    ...
    public void repeatGame(View v){
        stopService(new Intent(RabbitMapActivity54.this, SoundService.class));
        Intent gamePage = new Intent(this, RabbitMapActivity14.class);
