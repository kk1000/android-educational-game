...
public class FishMapActivity29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        startService(new Intent(FishMapActivity29.this, SoundService.class));
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_map_fish29);
        ...
        databasePoints = dbh.getPoints(2);
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f1) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba29a));
                        d1.setColorFilter(Color.parseColor("#40e0d0"));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f2) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba29b));
                        d2.setColorFilter(Color.parseColor("#40e0d0"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f3) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba29c));
                        d3.setColorFilter(Color.parseColor("#40e0d0"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f4) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba29d));
                        d4.setColorFilter(Color.parseColor("#40e0d0"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f5) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba29e));
                        d5.setColorFilter(Color.parseColor("#40e0d0"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f6) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba29f));
                        d6.setColorFilter(Color.parseColor("#40e0d0"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f7) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba29g));
                        d7.setColorFilter(Color.parseColor("#40e0d0"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f8) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba29h));
                        d8.setColorFilter(Color.parseColor("#40e0d0"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f9) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba29i));
                        d9.setColorFilter(Color.parseColor("#40e0d0"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
    ...
    public void turnOffMusic(View v){
        ...
        imageButton4.setVisibility(View.INVISIBLE);
        imageButton5.setVisibility(View.VISIBLE);
        stopService(new Intent(FishMapActivity29.this, SoundService.class));
    }
    ...
    public void repeatGame(View v){
        stopService(new Intent(FishMapActivity29.this, SoundService.class));
        Intent gamePage = new Intent(this, FishMapActivity29.class);
