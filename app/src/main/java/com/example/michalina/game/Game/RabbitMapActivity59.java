...
public class RabbitMapActivity59 extends AppCompatActivity {
    ...
    RatingBar points;
    ImageView d1,d2,d3,d4,d5,d6,d7,d8,d9,f1,f2,f3,f4,f5,f6,f7,f8,f9, smile, sad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        startService(new Intent(RabbitMapActivity59.this, SoundService.class));
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_map_rabbit49);
        ...
        d1=(ImageView) findViewById(R.id.imageView30);
        d6=(ImageView) findViewById(R.id.imageView46);
        d3=(ImageView) findViewById(R.id.imageView43);
        d5=(ImageView) findViewById(R.id.imageView45);
        d2=(ImageView) findViewById(R.id.imageView42);
        d4=(ImageView) findViewById(R.id.imageView44);
        d7=(ImageView) findViewById(R.id.imageView47);
        d8=(ImageView) findViewById(R.id.imageView48);
        d9=(ImageView) findViewById(R.id.imageView49);
        d1.setColorFilter(Color.GRAY);
        d2.setColorFilter(Color.GRAY);
        d3.setColorFilter(Color.GRAY);
        d4.setColorFilter(Color.GRAY);
        d5.setColorFilter(Color.GRAY);
        d6.setColorFilter(Color.GRAY);
        d7.setColorFilter(Color.GRAY);
        d8.setColorFilter(Color.GRAY);
        d9.setColorFilter(Color.GRAY);
        f1=(ImageView) findViewById(R.id.imageView50);
        f1.setOnTouchListener(new ChoiceTouchListener());
        f2=(ImageView) findViewById(R.id.imageView51);
        f2.setOnTouchListener(new ChoiceTouchListener());
        f3=(ImageView) findViewById(R.id.imageView52);
        f3.setOnTouchListener(new ChoiceTouchListener());
        f4=(ImageView) findViewById(R.id.imageView53);
        f4.setOnTouchListener(new ChoiceTouchListener());
        f5=(ImageView) findViewById(R.id.imageView54);
        f5.setOnTouchListener(new ChoiceTouchListener());
        f6=(ImageView) findViewById(R.id.imageView55);
        f6.setOnTouchListener(new ChoiceTouchListener());
        f7=(ImageView) findViewById(R.id.imageView56);
        f7.setOnTouchListener(new ChoiceTouchListener());
        f8=(ImageView) findViewById(R.id.imageView57);
        f8.setOnTouchListener(new ChoiceTouchListener());
        f9=(ImageView) findViewById(R.id.imageView58);
        f9.setOnTouchListener(new ChoiceTouchListener());
        ...
        d5.setOnDragListener(new ChoiceDragListener5());
        d6.setOnDragListener(new ChoiceDragListener6());
        d7.setOnDragListener(new ChoiceDragListener7());
        d8.setOnDragListener(new ChoiceDragListener8());
        d9.setOnDragListener(new ChoiceDragListener9());
        ...
        databasePoints = dbh.getPoints(3);
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f1) {
                        ...
                        new CountDownTimer(1000, 100) {
                            ...
                            public void onFinish() {
                                ...
                                if(smileNum==9){
                                    ...
                                    databasePoints.setPoints_amount((int)(pointsAmount*10)+3);
                                    dbh.updatePoint(databasePoints);
                                    pointsAmount=pointsAmount+0.3;
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik59a));
                        d1.setColorFilter(Color.parseColor("#a0522d"));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f2) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik59b));
                        d2.setColorFilter(Color.parseColor("#a0522d"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f3) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik59c));
                        d3.setColorFilter(Color.parseColor("#a0522d"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f4) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik59d));
                        d4.setColorFilter(Color.parseColor("#a0522d"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
    ...
    private class ChoiceDragListener5 implements View.OnDragListener{
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f5) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik59e));
                        d5.setColorFilter(Color.parseColor("#a0522d"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
    ...
    private class ChoiceDragListener6 implements View.OnDragListener{
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f6) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik59f));
                        d6.setColorFilter(Color.parseColor("#a0522d"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
    ...
    private class ChoiceDragListener7 implements View.OnDragListener{
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f7) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik59g));
                        d7.setColorFilter(Color.parseColor("#a0522d"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
    ...
    private class ChoiceDragListener8 implements View.OnDragListener{
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f8) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik59h));
                        d8.setColorFilter(Color.parseColor("#a0522d"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
    ...
    private class ChoiceDragListener9 implements View.OnDragListener{
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f9) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.krolik59i));
                        d9.setColorFilter(Color.parseColor("#a0522d"));
                        view.setImageDrawable(null);
                    }
                    else{
                        new CountDownTimer(1000, 100) {
    ...
    public void turnOffMusic(View v){
        ...
        imageButton4.setVisibility(View.INVISIBLE);
        imageButton5.setVisibility(View.VISIBLE);
        stopService(new Intent(RabbitMapActivity59.this, SoundService.class));
    }
    ...
    public void repeatGame(View v){
        stopService(new Intent(RabbitMapActivity59.this, SoundService.class));
        Intent gamePage = new Intent(this, RabbitMapActivity19.class);
