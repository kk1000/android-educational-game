...
public class FishMapActivity24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        startService(new Intent(FishMapActivity24.this, SoundService.class));
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_map_fish24);
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f1) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba24a));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f2) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba24b));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f3) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba24c));
            ...
            switch(event.getAction()){
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(view==f4) {
                        ...
                        ((ImageView) v).setImageDrawable(getResources().getDrawable(R.drawable.ryba24d));
    ...
    public void turnOffMusic(View v){
        ...
        imageButton4.setVisibility(View.INVISIBLE);
        imageButton5.setVisibility(View.VISIBLE);
        stopService(new Intent(FishMapActivity24.this, SoundService.class));
    }
    ...
    public void repeatGame(View v){
        stopService(new Intent(FishMapActivity24.this, SoundService.class));
        Intent gamePage = new Intent(this, FishMapActivity24.class);
